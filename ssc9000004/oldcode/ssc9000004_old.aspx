<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ssc9000004_old.aspx.cs" Inherits="ssc9000004" %>
    ...
    <div>
      ...
      <asp:Panel ID="Panel1" runat="server" Height="50px" Width="125px" Visible="false">
        ...
        <tr>
          ...
          <td><asp:TextBox ID="txtCenter" runat="server"  MaxLength="5" Width="72px"></asp:TextBox></td>
        </tr>
        <tr>
          <td></td>
          <td>
      ...
      <asp:GridView ID="MHMStoreSelectionGridView1" runat="server" 
        ...
        <Columns>
          ...
          <asp:Label ID="lblPanel1Status" runat="server" ForeColor="Red" Text="Label"></asp:Label>
          &nbsp;
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="item"
        ...
        <Columns>
          ...
          <asp:Label ID="lblPanel2Status" runat="server" ForeColor="Red" Text="Label"></asp:Label>
          &nbsp;
        </ContentTemplate>
      </asp:UpdatePanel>
          </td>
